 ...
 */
class responsedownload_responses_from_steps_walkthrough_test extends \mod_quiz\tests\attempt_walkthrough_testcase {
    static protected function get_full_path_of_csv_file($setname, $test) : string {
